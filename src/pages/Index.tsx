                ...
                <div className="rounded-lg border border-border/60 bg-popover/80 p-6 text-left">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
                    {[
                      ...
                      <div key={m.k} className="rounded-md border border-border/60 bg-card/60 px-3 py-2.5">
        ...
        <section className="border-t border-border/60 bg-card/30">
          <div className="container mx-auto px-6 py-14">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-5">
              {industries.map((ind) => (
                <div key={ind.label} className="flex items-center gap-2 text-muted-foreground transition-colors hover:text-foreground">
