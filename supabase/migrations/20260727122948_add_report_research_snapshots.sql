-- Additive prompt provenance and concept-resolution state for durable jobs.
...
-- These columns already exist in some environments; keep the migration safe
-- where schema history and generated types were previously ahead of migrations.
